...
class JobItem(BaseModel):
    ...
    last_heartbeat: Optional[datetime] = Field(default=None, description="Last heartbeat for long jobs")
    ...
    output_hashes: Dict[str, str] = Field(default_factory=dict, description="Output file SHA-256 map")
...
class RunManifest(BaseModel):
    ...
    status: str = Field(default="in_progress", description="Run status: in_progress, completed, failed")
